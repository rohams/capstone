...
public class MainUiTest {
	  ...
	  public void testUI() throws Exception {
	    driver.get(baseUrl);
	    assertEquals("Draw Ellipse", driver.findElement(By.id("control1")).getText());
	    assertEquals("Add a Store", driver.findElement(By.id("control3")).getText());
	    assertEquals("More Options", driver.findElement(By.id("control4")).getText());
	    assertEquals("Import", driver.findElement(By.cssSelector("button.import-button")).getText());
	    driver.findElement(By.id("control4")).click();
	    assertEquals("Find Weighted Average", driver.findElement(By.id("ave")).getText());
	    assertEquals("The Node to Add ...", driver.findElement(By.id("add_next")).getText());
	    assertEquals("The Node to Remove", driver.findElement(By.xpath("(//button[@id='add_next'])[2]")).getText());
